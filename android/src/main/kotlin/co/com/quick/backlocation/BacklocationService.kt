...
class BacklocationService: MethodChannel.MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
    companion object {
        const val METHOD_CHANNEL_NAME = "${BacklocationPlugin.PLUGIN_ID}/methods"
         ...
         */
        fun getInstance(): BacklocationService {
            if (instance == null) {
                instance = BacklocationService()
            }
            return instance!!
        }
    }
